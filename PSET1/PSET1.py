'''
init_balance = int(input("Please enter your balance"));
annual_interest = float(input("Please enter annual interest"));
...
while (balance > 0):
    ...
    monthly_payment += 10;
    num_month = 0;
    while (num_month < 12 and balance > 0 ):
        num_month +=1 
        interest = balance * monthly_interest;
        balance = balance - monthly_payment;
        balance = balance + interest;
monthly_payment = round(monthly_payment, 2);
print ("You need", num_month, "month/s to pay off debt.")
print ("You need to pay", monthly_payment, "monthly");
'''
